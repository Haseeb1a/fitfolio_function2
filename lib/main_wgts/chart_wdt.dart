...
class ChartState extends State<Chart> {
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                Visibility(
  visible: _selectedValue == 'Day' ? daytotal != 0 : _selectedValue == 'Week' ? weektotal != 0 : _selectedValue == 'Month' ? monthtotal != 0 : false,
  child: Padding(
    ...
    color: const Color.fromARGB(255, 255, 255, 255),
                    ...
                    value: _selectedValue,style: const TextStyle(color: Color.fromARGB(255, 255, 255, 255)),
                    items: <String>['Day', 'Week', 'Month']
                      ...
                      return DropdownMenuItem<String>(
                        ...
                        child: Text(
                          value,
                          style: const TextStyle(fontSize: 15,color: Color.fromARGB(255, 0, 0, 0),fontFamily:AutofillHints.username),
                        ),
                      );
                    }).toList(),
  ...
  List<PieChartSectionData> showingSections() {
    ...
    switch (_selectedValue) {
      ...
      case 'Month':
        ...
        int completedTasks =  monthcompleted; // Example: replace with actual data
  ...
  return List.generate(2, (i) {
    ...
    return PieChartSectionData(
      ...
      color: colors[i],
      value: values[i],
      title: 'Task ${values[i].toStringAsFixed(1)}%', // Limit to one decimal place
      radius: radius,
